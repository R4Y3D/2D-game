...
@export var health: int = 5  # Enemy health, adjustable in the editor
...
func _ready() -> void:
	...
	start_timer.wait_time = 15  # Delay appearance by 10 seconds
	...
	delete_timer.wait_time = 10  # Set for 15 seconds after becoming visible
